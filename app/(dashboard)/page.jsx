...
export default function HeroSection() {
  ...
  return (
    <div className="relative bg-gradient-to-br from-gray-100 to-white py-20 px-4 md:px-10 lg:px-16 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between space-y-8 md:space-y-0 md:space-x-12">
        ...
        <div className="flex-1 text-center md:text-left">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 leading-normal">
